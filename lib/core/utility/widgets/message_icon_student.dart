...
class MessageIconStudent extends StatefulWidget {
  const MessageIconStudent({super.key});

  @override
  State<MessageIconStudent> createState() => _MessageIconStudentState();
}

class _MessageIconStudentState extends State<MessageIconStudent> {
    ...
    return StreamBuilder<int>(
      ...
      builder: (context, snapshot) {
        ...
        return Stack(
          children: [
            IconButton(
              onPressed: () => Get.toNamed("/student-chats"),
