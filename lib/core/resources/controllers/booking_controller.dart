...
import 'package:silid/core/resources/models/class_bookings.dart';
...
class BookingController extends GetxController {
  ...
  var groupbookings = <GroupBookings>[].obs;
  ...
  Future<void> createClassBooking({
    ...
    try {
      ...
      DocumentReference bookingRef =
          _firestore.collection('group_bookings').doc();
      String bookingId = bookingRef.id; // Firestore-generated UID

      // Create a booking instance
      GroupBookings newBooking = GroupBookings(
        uid: bookingId,
        students: [],
        teacher: teacher,
        date: date,
